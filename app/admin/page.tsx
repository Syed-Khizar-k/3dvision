    ...
    <div className="flex min-h-screen bg-primary text-white max-md:pt-[70px]">
      ...
      <main className="flex-1 md:ml-64 p-6 md:p-10">
        ...
        <div className="pt-10 md:hidden space-y-4">
          {forms.map((f) => (
            <div key={f._id} className="border rounded-lg shadow-lg p-4 bg-white text-black">
              ...
              <div className="space-y-2 text-sm mt-2">
                ...
                <div><strong>Company: </strong> {f.company}</div>
                <div><strong>Type: </strong> {f.projectType}</div>
              </div>
