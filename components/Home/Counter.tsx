...
const CounterDefault = () => {
 ...
 return (
  ...
  <div className="py-20 w-full bg-(--color-three)">
       ...
       <div key={num}>
        <div className="group relative w-full text-center p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition duration-300 transform hover:scale-[1.02] overflow-hidden">
         ...
         <div className="relative z-10">
          <div className="text-(--color-secondary) mb-4 flex justify-center group-hover:text-white transition-colors duration-300">
           <item.Icon className="w-8 h-8" strokeWidth={1.5} />
          </div>
          <div className="mt-4">
           <h1 className="text-[18px] md:text-[32px] font-bold text-(--color-secondary) flex justify-center items-center group-hover:text-white transition-colors duration-300">
            <CountUpContent number={item.countNum} text="" />
            <span className="text-(--color-secondary) text-3xl ml-2 group-hover:text-white transition-colors duration-300">
             +
            </span>
           </h1>
