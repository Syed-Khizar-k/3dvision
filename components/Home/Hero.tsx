...
export const HeroSection: React.FC = () => {
 ...
 useEffect(() => {
  // Force play for iOS policies if needed, though 'autoplay=1' & 'playsinline=1' usually suffice.
  // Using postMessage as requested to ensure playback command is sent.
  ...
  }, 2000); // Check every 2s (or run once on load)
  ...
  <section className="relative w-full h-screen overflow-hidden bg-white">
   ...
   <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none select-none">
    ...
    <iframe
     ...
     src="https://www.youtube.com/embed/Jbvts0kdCo0?autoplay=1&mute=1&loop=1&playlist=Jbvts0kdCo0&controls=0&showinfo=0&rel=0&modestbranding=1&iv_load_policy=3&disablekb=1&enablejsapi=1&playsinline=1"
